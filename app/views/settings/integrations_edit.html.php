	...
	<div class="col-md-10">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p>Here is the <a target="blank" href="https://developers.tune.com/network-docs/setting-up-api-authentication/">HasOffers documentation <span class="glyphicon glyphicon-new-window" aria-hidden="true"></span></a> on how to get this information.</p>
				<h4><?= APP_NAME ?> IPs</h4>
