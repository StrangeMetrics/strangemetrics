<h1 class="page-header">New Analysis</h1>
...
<div class="row">
	<form class="col-md-6" method="POST" action="<?= url_for('/analysis/new') ?>">
		...
		<button class="btn btn-primary pull-right" type="submit">Create Analysis</button>
	</form>
